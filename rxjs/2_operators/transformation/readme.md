...
### 예제 2 ([bufferConnt_1.js](./bufferCount_1.js))
...
### 예제 3 ([bufferCount_2.js](./bufferCount_2.js))
...
### 예제 4 ([bufferTime.js](./bufferTime.js))
...
### 예제 6 ([bufferToggle.js](./bufferToggle.js))
...
옵저버블이 방출는 값을 버퍼에 담고 있다가 <code>closingSelector</code> 옵저버블이 방출되면 버퍼에 쌓인 항목을 방출하고, 다음 <code>closingSelector</code>이 방출될 때까지 반복합니다.

### 예제 7 ([bufferWhen.js](./bufferWhen.js))
